    ...
    <UCard class="border border-blue-400">
        <div class="space-y-3">
            <div class="flex items-start justify-between gap-4">
                <div class="flex-1 min-w-0">
                    ...
                    <div class="flex items-center gap-2">
                        <ULink :to="`${url.shortUrl}`" target="_blank"
                            class="text-blue-500 hover:text-blue-600 dark:text-blue-400 dark:hover:text-blue-500 font-medium text-lg flex items-center gap-2"
                ...
                <UButton color="neutral" variant="outline" class="h-10 w-10 text-center"
